		  ...
		  int tstamp_since_epoch, int tstamp_utc)
{
  ...
  if (wtc_2 & COUNT_TUNNEL_OPT_CLASS) json_object_set_new_nocheck(obj, "tunnel_opt_class", json_integer((json_int_t)ptun->tunnel_opt_class));
  if (wtc_2 & COUNT_TUNNEL_OPT_TYPE) json_object_set_new_nocheck(obj, "tunnel_opt_type", json_integer((json_int_t)ptun->tunnel_opt_class));
